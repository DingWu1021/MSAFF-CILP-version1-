...
def evaluation_Gait3D(data, conf, probe_num, metric='euc'):
    ...
    # xia mian shi wo xie de

    msg_mgr.log_info(f"Rank-1: {results['Rank-1']:.2f}, Rank-5: {results['Rank-5']:.2f}, Rank-10: {results['Rank-10']:.2f}")
    msg_mgr.log_info(f"mAP: {results['mAP']:.2f}, mINP: {results['mINP']:.2f}")
    
    print(f"Rank-1: {results['Rank-1']:.2f}, Rank-5: {results['Rank-5']:.2f}, Rank-10: {results['Rank-10']:.2f}")
    print(f"mAP: {results['mAP']:.2f}, mINP: {results['mINP']:.2f}")
